...
const Hero = () => {
  return (
    <div className="md:h-screen md:pt-0 pt-[10rem] relative bg-stone-100 flex flex-col justify-center items-center md:px-[6rem] px-6 text-neutral-800">
      <AnimatedGridPattern
        numSquares={20}
        maxOpacity={0.1}
        duration={3}
      ...
      >
        ...
        <motion.div
          className="flex flex-col items-center gap-2 md:max-w-sm absolute bottom-[5%]"
          variants={containerVariants}
        >
          <motion.p
